...
--
-- Host: localhost
-- Generation Time: Oct 01, 2013 at 07:05 PM
...
INSERT INTO `film_hall` (`f_hall_id`, `manager_id`, `hall_name`, `location`) VALUES
(1, 1, 'Sky cinama', 'No 11,\r\nPeradeniya road,\r\nKandy.'),
(2, 1, 'city cinema', 'No 45, main street, Kandy');
...
INSERT INTO `operators` (`o_id`, `f_name`, `l_name`, `email`, `nic`, `f_hall_id`) VALUES
(1, 'sasitha', 'madushanka', 'sasithamadushanka@gmail.com', '892053863v', 2);
